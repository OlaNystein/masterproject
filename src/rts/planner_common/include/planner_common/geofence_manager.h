...
public:
  ...
  // Don't modify this directly to avoid incorrect format, use provided constructors
...
class GeofenceManager {
 public:
  ...
  void addGeofenceArea(const geometry_msgs::Polygon poly_msg, bool merge = false);
